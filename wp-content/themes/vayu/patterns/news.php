...
<p class="has-text-align-center has-text-color has-link-color" style="color:#6467ec;font-style:normal;font-weight:600"><?php echo esc_html__( 'Blog', 'vayu' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center has-body-font-family" style="font-size:42px;font-style:normal;font-weight:700;letter-spacing:1px;line-height:1.3"><?php echo esc_html__( 'Read Our Latest News', 'vayu' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
